...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-black text-white font-inter overflow-hidden">
      {/* Animated Background Elements */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-64 h-64 bg-blue-500/10 rounded-full animate-pulse"></div>
        <div className="absolute top-40 right-20 w-32 h-32 bg-blue-400/15 rounded-full animate-bounce delay-100"></div>
        <div className="absolute bottom-32 left-1/4 w-48 h-48 bg-blue-600/10 rounded-full animate-pulse delay-200"></div>
        <div className="absolute bottom-20 right-10 w-20 h-20 bg-blue-500/25 rounded-full animate-bounce delay-300"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-500/5 to-indigo-500/5 rounded-full animate-spin-slow"></div>
      </div>
      ...
      <section className="relative z-10 container mx-auto px-4 pt-12 pb-8 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            ...
            <span className="text-blue-400 block">$20K/Month</span>
            in 60 Days
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Learn the exact system we used to scale from scratch to making over 
            <span className="text-blue-400 font-semibold"> $1M+ per year </span>
            selling AI services to businesses
          </p>
          <Button 
            onClick={handleApplyNow}
            className="bg-blue-600 hover:bg-blue-700 text-white text-lg px-8 py-6 rounded-lg font-semibold transform hover:scale-105 transition-all"
          >
      ...
      <section className="relative z-10 container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto animate-fade-in">
          ...
          <div className="text-center mt-8">
            <Button 
              onClick={handleApplyNow}
              className="bg-blue-600 hover:bg-blue-700 text-white text-lg px-8 py-4 rounded-lg font-semibold transform hover:scale-105 transition-all"
            >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-slate-800/50 backdrop-blur-sm transform hover:scale-105 transition-all animate-fade-in">
                <CardContent className="p-6">
                  <div className="w-full h-48 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 rounded-lg mb-4 flex items-center justify-center">
                    <span className="text-gray-400">Student Result Image</span>
                  </div>
                  <div className="text-3xl font-bold text-blue-400 mb-2">$12K/Month</div>
                  <p className="text-gray-300 mb-4">"Scaled from $2K to $12K/month in just 60 days using this exact system"</p>
              ...
              <Card className="bg-slate-800/50 backdrop-blur-sm transform hover:scale-105 transition-all animate-fade-in delay-100">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold text-blue-400 mb-2">$25K/Month</div>
              ...
              <Card className="bg-slate-800/50 backdrop-blur-sm transform hover:scale-105 transition-all animate-fade-in delay-200">
                <CardContent className="p-6">
                  ...
                  <div className="text-3xl font-bold text-blue-400 mb-2">$50K/Month</div>
      ...
      <section className="relative z-10 bg-slate-900/50 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-blue-900/30 to-slate-900/50 p-8 rounded-lg backdrop-blur-sm animate-fade-in">
              ...
              <div className="bg-gradient-to-br from-slate-900/50 to-blue-900/30 p-8 rounded-lg backdrop-blur-sm animate-fade-in delay-100">
            ...
            <div className="mt-12">
              <Button 
                onClick={handleApplyNow}
                className="bg-blue-600 hover:bg-blue-700 text-white text-xl px-12 py-6 rounded-lg font-semibold transform hover:scale-105 transition-all animate-fade-in"
              >
      ...
      <section className="relative z-10 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-blue-900/40 to-slate-900/50 p-12 rounded-lg backdrop-blur-sm animate-fade-in">
              ...
              <Button 
                onClick={handleApplyNow}
                className="bg-blue-600 hover:bg-blue-700 text-white text-xl px-12 py-6 rounded-lg font-semibold transform hover:scale-105 transition-all"
              >
